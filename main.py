...
class VtkPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        #self.readDicomImages()
        # OLD Data
        #image = self.adjustImageThreshold(800)
        #self.__plotImage(image)
        #self.createVolume()
        #self.decimateVolume()
        #self.smoothVolume(type="laplacian", level=5)
    ...
    def loadView(self):
        ...
        loadSaveStaticBox = wx.StaticBox(self, -1, "Load and Save")
        self.wxLoadSaveStaticBox = wx.StaticBoxSizer(loadSaveStaticBox, wx.VERTICAL)
        ...
        configurationStaticBox = wx.StaticBox(self, -1, "Configuration")
        self.wxConfigurationStaticBox = wx.StaticBoxSizer(configurationStaticBox, wx.VERTICAL)
        ...
        self.bottomSizer.Add(self.wxConfigurationStaticBox, 0, wx.EXPAND)

                # Sliders
        self.wxLowerStaticText = wx.StaticText(self, -1, "Lower: 0")
        self.wxConfigurationStaticBox.Add(self.wxLowerStaticText, 0, wx.EXPAND | wx.ALL, 5)

        self.wxLowerSlider = wx.Slider(self, -1, minValue=0, maxValue=100)
        self.wxConfigurationStaticBox.Add(self.wxLowerSlider, 0, wx.EXPAND | wx.ALL, 5)

        self.wxUpperStaticText = wx.StaticText(self, -1, "Upper: 0")
        self.wxConfigurationStaticBox.Add(self.wxUpperStaticText, 0, wx.EXPAND | wx.ALL, 5)

        self.wxUpperSlider = wx.Slider(self, -1, minValue=0, maxValue=100)
        self.wxConfigurationStaticBox.Add(self.wxUpperSlider, 0, wx.EXPAND | wx.ALL, 5)

        # Filter Section
        filterStaticBox = wx.StaticBox(self, -1, "Filters")
        self.wxFilterStaticBox = wx.StaticBoxSizer(filterStaticBox, wx.VERTICAL)
    ...
    def OnButtonLoadImageClick(self, evt):
        dirDialog = wx.DirDialog(self,
                                 ...
                                 #defaultPath=r"C:\Projects\IC\dental",  # Temporary
    ...
    def loadDicomImages(self, dicomFilesPath):
        ...
        try:
            dicomFile = dicom.read_file(dicomPath)
    ...
    def adjustImageThreshold(self, lower_limit=None, upper_value=None):
        ...
        print self.DICOM_IMAGES.GetOutputPort()
    ...
    def view3DImage(self, imageData):
        ...
        volume_3d.GetProperty().SetColor(1, 0, 0)
...
def main():
    ...
    #VtkFrame(title="teste",imagePath=r"C:\Users\work\Desktop\dicoms\old\dentalTeste")

    #VtkFrame(title="teste",imagePath=r"dental")
